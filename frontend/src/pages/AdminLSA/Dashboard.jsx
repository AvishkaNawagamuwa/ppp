...
import { FiGrid, FiClock, FiCreditCard, FiFileText } from "react-icons/fi";
  ...
  return (
    <div className="animate-fadeIn">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Welcome to Lanka Spa Association Admin Panel</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6 transition-transform duration-300 hover:scale-105">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-sm font-medium text-gray-600">Total Spas</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6 transition-transform duration-300 hover:scale-105">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-800">LKR 245,000</p>
            </div>
          </div>
        </div>
          ...
          {[1, 2, 3, 4, 5].map((item) => (
            <div key={item} className="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-300">
              <div className="flex-shrink-0 w-10 h-10 bg-gold-100 rounded-full flex items-center justify-center">
                <span className="text-gold-600 font-semibold">LSA</span>
              </div>
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-800">New spa registration submitted</p>
