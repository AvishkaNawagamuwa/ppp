...
const ResignTerminate = () => {
    ...
    const [therapists, setTherapists] = useState([
        { id: 1, name: 'Dr. Amara Silva', email: 'amara@spa.com', phone: '+94 77 123 4567', specialization: 'Swedish Massage', status: 'active', joinDate: '2024-01-15', requestStatus: null },
        { id: 2, name: 'Priya Fernando', email: 'priya@spa.com', phone: '+94 77 987 6543', specialization: 'Deep Tissue', status: 'active', joinDate: '2023-11-20', requestStatus: null },
        { id: 3, name: 'Kasun Perera', email: 'kasun@spa.com', phone: '+94 77 555 0123', specialization: 'Thai Massage', status: 'pending_review', joinDate: '2023-08-10', requestStatus: 'resign_requested' },
        { id: 4, name: 'Nimal Raj', email: 'nimal@spa.com', phone: '+94 77 444 0987', specialization: 'Aromatherapy', status: 'active', joinDate: '2024-03-05', requestStatus: null }
    ]);
