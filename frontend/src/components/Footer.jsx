        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gold-500 text-[#0A1428] h-10 w-10 rounded-full flex items-center justify-center transition-all duration-300 hover:bg-gold-600 hover:scale-110">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-gray-300 hover:text-gold-500 transition-colors duration-300 flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-2 text-gold-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">info@lankaspa.lk</span>
              </li>
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gold-500 mr-3 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Lanka Spa Association. All rights reserved.
            </p>
